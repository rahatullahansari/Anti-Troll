...
class TwitterProxy {
	 ...
	 */
	public function __construct($oauth_access_token, $oauth_access_token_secret, $consumer_key, $consumer_secret, $search) {

		$this->config = array_merge($this->config, compact('oauth_access_token', 'oauth_access_token_secret', 'consumer_key', 'consumer_secret', 'search'));

		$this->whitelist['users/show.json?screen_name=' . $this->config['search']] = true;
	}
